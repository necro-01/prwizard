...
class PromptService {
    static generateDiffReviewPrompt(details) {
        const context = 'Your objective is to meticulously review a diff from a git repository and ' +
    ...
    static generateFileReviewPrompt(fileContent, filename) {
        const context = 'As an expert code reviewer, your main duty is to ensure that the code conforms to ' +
    ...
    static generateCommitMessagePrompt(details, commitHistory) {
        const context = 'As an experienced code reviewer, your task is to identify the most appropriate commit ' +
